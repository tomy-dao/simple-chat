...
export function ChatMessages({
  ...
  return (
    (<div
      ...
      <div className="max-w-full [grid-column:1/1] [grid-row:1/1] px-2">
        {children}
      </div>
      {!shouldAutoScroll && (
        <div
          className="pointer-events-none flex flex-1 items-end justify-end [grid-column:1/1] [grid-row:1/1] px-2">
